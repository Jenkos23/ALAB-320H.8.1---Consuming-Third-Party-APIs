...
## Description
The Starships App is a React application that fetches and displays a list of starships from
a Third-Party-API SWAPI (https://swapi.dev/api/)
The application handles loading states and error handling gracefully, providing a smooth user experience. It showcases the power of React hooks and component-based architecture. 
...
1. Clone the repository:
   ```bash
   git clone [https://github.com/Jenkos23/ALAB-320H.8.1---Consuming-Third-Party-APIs.git]
   ```
